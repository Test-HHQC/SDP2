...
- $O_I$ calculates the $index_{A_j}$: [n]x[s] $\rightarrow$ [n] function \[3\]
- 
      $$O_I |j,k,l\rangle = |j,k,index_{A_j}(k,l)\rangle$$
- another oracle $O_M$ , returning a bitstring representation of $(𝐴_𝑗)_{𝑘𝑖}$ for any 𝑗∈{0}⋃[𝑚] and  𝑘,𝑖 $\in$[𝑛]
- 
